...
public class FragFive extends Fragment {
    ...
    private FragFiveViewModel fragFiveViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        fragFiveViewModel =
                ViewModelProviders.of(this).get(FragFiveViewModel.class);
        ...
        fragFiveViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
