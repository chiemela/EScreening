...
public class FragThree extends Fragment {
    ...
    private FragThreeViewModel fragThreeViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        fragThreeViewModel =
                ViewModelProviders.of(this).get(FragThreeViewModel.class);
        ...
        fragThreeViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
